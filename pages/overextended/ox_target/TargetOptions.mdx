...
- iconColor?: `string`
- distance?: `number`
  - Distância máxima para exibir a opção.
...
- data: `table`
  ...
  - coords: `vector3`
    - As coordenadas resultantes onde o teste de colisão atingiu.
  - distance: `number`
    - Distância do jogador até as coordenadas.
  - zone?: `number`
    - O id da zona selecionada, se aplicável.
